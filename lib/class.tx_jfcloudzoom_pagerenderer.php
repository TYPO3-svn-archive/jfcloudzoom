 ...
 */
class tx_jfcloudzoom_pagerenderer
{
	public $conf = array();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfcloudzoom/lib/class.tx_jfcloudzoom_pagerenderer.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfcloudzoom/lib/class.tx_jfcloudzoom_pagerenderer.php']);
}
